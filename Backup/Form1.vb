...
Partial Public Class Form1
	...
	Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		If Not System.IO.File.Exists(AppDomain.CurrentDomain.GetData("DataDirectory").ToString & "\Command3808.sdf") Then
			If MsgBox("Command3808 allows you to control your Denon AVR-3808CI using the telnet protocol. Command3808 sends commands to your Denon and processes any responses. Command3808 is free for non-commercial use. The Command3808 source code is free for non-commercial use provided you cite Command3808 in the derived work. Photos of the Denon 3808CI Photo in this program are Copyright D&M Holdings, Inc. This program is in no way associated with, produced by, or other otherwise endorsed by D&M Holdings, Inc." & vbCrLf & vbCrLf & "THIS PROGRAM AND ITS SOURCE CODE ARE PROVIDED **** AS IS **** AND THERE IS NO WARRANTY EITHER STATED OR IMPLIED. YOU USE THIS PROGRAM AT YOUR OWN RISK." & vbCrLf & vbCrLf & "This is your first time using this program. Do you wish to continue?", MsgBoxStyle.Question Or MsgBoxStyle.YesNo Or MsgBoxStyle.DefaultButton2) = MsgBoxResult.No Then
				End
			End If
		End If
...
#Region "Button Events"
	...
	Private Sub Button52_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button52.Click
		If MsgBox("This will reset the internal Command3808 database. All of your personal settings and other stored information will be lost. This action does not interact with your Denon in any way. The database in question here only applies to Command3808, so you can't harm your receiver by carrying out this action." & vbCrLf & vbCr & "Do you wish to continue?", MsgBoxStyle.Exclamation Or MsgBoxStyle.YesNo Or MsgBoxStyle.DefaultButton2) = MsgBoxResult.Yes Then
			DB.Reset()
		End If
	End Sub
	...
	Private Sub Button87_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button87.Click
		...
		If ListBox1.SelectedItems.Count = 1 Then
			...
			ds = dsScripts.Clone
			dt.TableName = "Command3808 Version Info"
			...
			SaveFileDialog1.Filter = "Command3808 Script Files|*.c3s|All Files|*.*"
	...
	Private Sub Button88_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button88.Click
		...
		OpenFileDialog1.Filter = "Command3808 Script Files|*.c3s|All Files|*.*"
...
#Region "ComboBox Events"
	...
	Private Sub ComboBox13_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox13.SelectedIndexChanged
		...
		Try
			...
			If Not booLoading AndAlso Helper.CheckIP(False, False) Then
				Commands.SendRecordSelect(DirectCast(ComboBox13.SelectedItem, Source))
				SetControlWaiting(ComboBox13)
			End If
