...
Public Class Form1
	...
	Sub ConfigureOnOffRadioButtons()
		...
		RadioButton3.Tag = OnOffCommand.ToneDefeatOn
		RadioButton4.Tag = OnOffCommand.ToneDefeatOff
	...
	Sub ConfigureFixedListComboBoxes()
		...
		l = New KeyValueList(Of String, String)
		l.AddNew("SMALL", "S")
		l.AddNew("MED-SMALL", "MS")
		l.AddNew("MEDIUM", "M")
		l.AddNew("MED-LARGE", "ML")
		l.AddNew("LARGE", "L")
		...
		l.AddNew("PL2X CINEMA", "PL2X CINEMA")
		l.AddNew("PL2X MUSIC", "PL2X MUSIC")
		l.AddNew("ON", "ON")
		l.AddNew("OFF", "OFF")
		...
		l.AddNew("DSP WIDE SCREEN", "WIDE SCREEN")
		l.AddNew("DSP 5 CHANNEL STEREO", "5CH STEREO")
		l.AddNew("DSP 7 CHANNEL STEREO", "7CH STEREO")
		l.AddNew("DSP SUPER STADIUM", "SUPER STADIUM")
		l.AddNew("DSP ROCK ARENA", "ROCK ARENA")
		l.AddNew("DSP JAZZ CLUB", "JAZZ CLUB")
		l.AddNew("DSP CLASSICAL MUSIC CONCERT", "CLASSIC CONCERT")
	...
	Sub FillSources()
		...
		If My.CustomSettings.Sources.Instance.Value.Count = 0 Then
			...
			s = New Source("PHONO", SourceType.PHONO)
			...
			l.Add(s.SourceName, s)
			s = New Source("HDP", SourceType.HDP)
			l.Add(s.SourceName, s)
			s = New Source("TV/CBL", SourceType.TVCBL)
			l.Add(s.SourceName, s)
			s = New Source("SAT", SourceType.SAT)
			l.Add(s.SourceName, s)
			s = New Source("VCR", SourceType.VCR)
			l.Add(s.SourceName, s)
			s = New Source("DVR", SourceType.DVR)
			l.Add(s.SourceName, s)
			s = New Source("V.AUX", SourceType.VAUX)
			l.Add(s.SourceName, s)
			s = New Source("NET/USB", SourceType.NETUSB)
			l.Add(s.SourceName, s)
			s = New Source("XM", SourceType.XM)
			l.Add(s.SourceName, s)
		...
		For Each kvp As KeyValuePair(Of String, Source) In lSourceInfo
			...
			If s.IsActive Then
				...
				Select Case s.SourceType
					Case SourceType.DVD, SourceType.HDP, SourceType.TVCBL, SourceType.SAT, SourceType.VCR, SourceType.DVR, SourceType.VAUX, SourceType.SOURCE
						l.Add(s)
				End Select
...
#Region "Set UI"
	...
	Public Sub SetOnOff(ByVal cmd As OnOffCommand)
		...
		Select Case cmd
			Case OnOffCommand.ToneDefeatOff
				rb = RadioButton4
			Case OnOffCommand.ToneDefeatOn
				rb = RadioButton3
	...
	Public Sub SetRecordSelect(ByVal v As Source)

		booLoading = True

		If Not IsNothing(v) Then
			ComboBox13.SelectedItem = v
			SetLastControlInfo(ComboBox13)
			ClearControlWaiting(ComboBox13)
		End If
