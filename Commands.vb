...
#Region "Query"
	...
	Public Shared Sub QueryChannelVolume(ByVal c As Channel)
		...
		Select Case c
            ...
            Case Channel.LeftHeight
                EnqueueRequest("CVFHL?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.RightHeight
                EnqueueRequest("CVFHR?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.LeftWide
                EnqueueRequest("CVFWL?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.RightWide
                EnqueueRequest("CVFWR?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    ...
    Public Shared Sub QueryAudysseyMode()
        EnqueueRequest("PSMULTEQ: ?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    End Sub

    Public Shared Sub QueryDynVol()
        EnqueueRequest("PSDYNVOL ?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    End Sub

    Public Shared Sub QueryDynEQ()
        EnqueueRequest("PSDYNEQ ?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    End Sub

    Public Shared Sub QueryRefLev()
        EnqueueRequest("PSREFLEV ?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    End Sub
    ...
    Public Shared Sub QuerySourceNames()
        EnqueueRequest("SS FUN?", My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
    End Sub
...
#Region "Command"
    ...
    Public Shared Sub SendChannelVolume(ByVal c As Channel, ByVal v As ChannelVolume)
        ...
        Select Case c
            ...
            Case Channel.LeftHeight
                EnqueueRequest("CVFHL " & v.DenonCommandValue, My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.RightHeight
                EnqueueRequest("CVFHR " & v.DenonCommandValue, My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.LeftWide
                EnqueueRequest("CVFWL " & v.DenonCommandValue, My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.RightWide
                EnqueueRequest("CVFWR " & v.DenonCommandValue, My.CustomSettings.DefaultCommandPauseMS.Instance.Value)
            Case Channel.LeftRear
...
#Region "Parse"
    ...
    Public Shared Sub ParseMSResponse(ByVal m As String)
        ...
        Select Case m
            ...
            Case "MSSTEREO"
                ...
                strSetting = "STEREO"
            Case "MSMULTI CH IN"
                strMode = "Multi Channel In"
            Case "MSM CH IN+PL2X C"
                strMode = "Multi Channel In + PLIIx Cinema"
            Case "MSM CH IN+PL2X M"
                strMode = "Multi Channel In + PLIIx Music"
            Case "MSM CH IN+PL2Z H"
                strMode = "Multi Channel In + PLIIz Height"
            Case "MSM CH IN+DOLBY EX"
                strMode = "Multi Channel In + Dolby EX"
            Case "MSMULTI CH IN 7.1"
                strMode = "Multi Channel In 7.1"
            Case "MSDOLBY PRO LOGIC"
                strMode = "Dolby Pro Logic"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2 C"
                strMode = "Dolby Pro Logic II Cinema"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2 M"
                strMode = "Dolby Pro Logic II Music"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2 G"
                strMode = "Dolby Pro Logic II Game"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2X C"
                strMode = "Dolby Pro Logic IIx Cinema"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2X M"
                strMode = "Dolby Pro Logic IIx Music"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2X G"
                strMode = "Dolby Pro Logic IIx Game"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY PL2Z H"
                strSetting = "Dolby Pro Logic IIz Height"
            ...
            Case "MSDOLBY D+PL2X C"
                strMode = "Dolby Digital PLIIx Cinema"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY D+PL2X M"
                strMode = "Dolby Digital PLIIx Music"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY D+PL2Z H"
                strMode = "Dolby Digital PLIIz Height"
                strSetting = "DOLBY DIGITAL"
            Case "MSDTS NEO:6 C"
            ...
            Case "MSDTS ES DSCRT6.1"
                strMode = "DTS-ES Discrete 6.1"
                strSetting = "DTS SURROUND"
            Case "MSDTS ES MTRX6.1"
                strMode = "DTS-ES Matrix 6.1"
                strSetting = "DTS SURROUND"
            Case "MSDTS+PL2X C"
                strMode = "DTS Surround + PLIIx Cinema"
                strSetting = "DTS SURROUND"
            Case "MSDTS+PL2X M"
                strMode = "DTS Surround + PLIIx Music"
                strSetting = "DTS SURROUND"
            Case "MSDTS+PL2Z H"
                strMode = "DTS Surround + PLIIz Height"
                strSetting = "DTS SURROUND"
            Case "MSDTS+NEO:6"
                strMode = "DTS Surround + NEO:6"
                strSetting = "DTS SURROUND"
            Case "MSDTS96/24"
                strMode = "DTS Surround 96/24"
            Case "MSMCH STEREO"
                strMode = "Multi Channel Stereo"
                strSetting = "MCH STEREO"
            Case "MSROCK ARENA"
            ...
            Case "MSDOLBY D+ +EX"
                ...
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY D+ +PL2X C"
                strMode = "Dolby Digital Plus + PLIIx Cinema"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY D+ +PL2X M"
                strMode = "Dolby Digital Plus + PLIIx Music"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY D+ +PL2Z H"
                strMode = "Dolby Digital Plus + PLIIz Height"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY HD"
            ...
            Case "MSDOLBY HD+PL2X C"
                strMode = "Dolby True HD + PLIIx Cinema"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY HD+PL2X M"
                strMode = "Dolby True HD + PLIIx Music"
                strSetting = "DOLBY DIGITAL"
            Case "MSDOLBY HD+PL2Z H"
                strMode = "Dolby True HD + PLIIz Height"
            Case "MSDTS HD"
                strMode = "DTS HD"
                strSetting = "DTS SURROUND"
            Case "MSDTS HD MSTR"
                strMode = "DTS-HD Master Audio"
                strSetting = "DTS SURROUND"
            Case "MSDTS ES 8CH DSCRT"
                strMode = "DTS-ES 8 Channel Discrete"
                strSetting = "DTS SURROUND"
            Case Else
    ...
    Public Shared Sub ParsePSResponse(ByVal m As String)
        ...
        If rx.IsMatch(m) Then
            ...
            Select Case m
                Case Helper.GetCommandPrefixForOnOff(OnOffCommand.DynamicEQOff) & "OFF"
                    Form1.SetOnOff(OnOffCommand.DynamicEQOff)
                    booProcessed = True
                Case Helper.GetCommandPrefixForOnOff(OnOffCommand.DynamicEQOn) & "ON"
                    Form1.SetOnOff(OnOffCommand.DynamicEQOn)
                    booProcessed = True
                Case Helper.GetCommandPrefixForOnOff(OnOffCommand.ToneCtrlOff) & "OFF"
                    Form1.SetOnOff(OnOffCommand.ToneCtrlOff)
                    booProcessed = True
                Case Helper.GetCommandPrefixForOnOff(OnOffCommand.ToneCtrlOn) & "ON"
                    Form1.SetOnOff(OnOffCommand.ToneCtrlOn)
                    booProcessed = True
        ...
        If Not booProcessed Then
            ...
            ElseIf m.Length >= 9 AndAlso m.Substring(0, 9) = "PSMULTEQ:" Then
                Form1.SetFixedListComboBox(m.Substring(9), FixedListComboBox.AudysseyMode)
            ElseIf m.Length >= 9 AndAlso m.Substring(0, 9) = "PSDYNVOL " Then
                Form1.SetFixedListComboBox(m.Substring(9), FixedListComboBox.DynamicVolume)
            ElseIf m.Length >= 9 AndAlso m.Substring(0, 9) = "PSREFLEV " Then
                Form1.SetFixedListComboBox(m.Substring(9), FixedListComboBox.ReferenceLevel)
    ...
    Public Shared Function ParseChannelVolumeResponse(ByVal m As String) As ReadWriteKeyValuePair(Of Channel, ChannelVolume)
        ...
        If Not IsNothing(ma) AndAlso ma.Success Then
            ...
            Select Case ma.Groups(1).Value
                ...
                Case "FHL"
                    c = Channel.LeftHeight
                Case "FHR"
                    c = Channel.RightHeight
                Case "FWL"
                    c = Channel.LeftWide
                Case "FWR"
                    c = Channel.RightWide
